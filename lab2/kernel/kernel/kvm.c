...
void initFS () {
	...
	putString("SectorNum:\t"); 		putInt(sBlock.sectorNum);
	putString("InodeNum:\t"); 		putInt(sBlock.inodeNum);
	putString("BlockNum:\t"); 		putInt(sBlock.blockNum);
	putString("AvailInodeNum:\t"); 	putInt(sBlock.availInodeNum);
	putString("AvailBlockNum:\t"); 	putInt(sBlock.availBlockNum);
	putString("BlockSize:\t"); 		putInt(sBlock.blockSize);
	putString("InodeBitmap:\t"); 	putInt(sBlock.inodeBitmap);
	putString("BlockBitmap:\t");		putInt(sBlock.blockBitmap);
	putString("InodeTable:\t"); 		putInt(sBlock.inodeTable);
	putString("Blocks:\t\t"); 			putInt(sBlock.blocks);
}
